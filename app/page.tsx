  ...
  return (
    <main className="bg-bg text-white overflow-hidden">
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <a href="https://calendly.com/meetwithsumit/30min" className="rounded-lg border border-accent/30 px-4 py-2 text-sm font-semibold text-accent hover:bg-accent/10 transition">
          Get in Touch
        </a>
      </nav>
      ...
      <section className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-28 text-center">
          ...
          <div className="mt-12 flex justify-center">
            <a href="https://calendly.com/meetwithsumit/30min" className="relative group inline-flex items-center gap-2 rounded-xl bg-accent px-8 py-4 font-semibold text-slate-900 transition-all duration-300 hover:scale-[1.04]">
      ...
      <section id="contact" className="text-center py-24">
        ...
        <a href="https://calendly.com/meetwithsumit/30min" className="inline-flex rounded-xl bg-accent px-10 py-4 font-semibold text-slate-900 hover:scale-105 transition">
